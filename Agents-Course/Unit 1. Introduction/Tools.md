...
But we can also use Python’s `inspect` module to retrieve all the information for us! This is what the `@tool` decorator does. Here is an example of a decorator code that creates a `Tool` instance:
