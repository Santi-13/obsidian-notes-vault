...
```python
B = np.load('eigenfaces.npy')[:200] # we use the first 50 basis vectors --- you should play around with this.
...
def show_face_face_reconstruction(i):
    ...
    print("B_basis is shape ", B_basis.shape)
...
```
    ...
    the random basis has shape (100, 64, 64)
