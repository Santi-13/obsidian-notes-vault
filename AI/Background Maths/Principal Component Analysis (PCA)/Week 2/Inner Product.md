...
---
An ***inner product*** is a generalization of the ***[[AI/Background Maths/Principal Component Analysis (PCA)/Week 2/Dot Product|Dot Product]]*** that allows us to measure the *geometric properties* of **vectors** (angles, distances and lengths). This includes complex vectors.
