...
Setting up a static address is often advantageous for devices that need to or are regularly accessed via a particular IPv4 address, as it wouldn't be good if the address changed. And although it can grant more control of the *network*, it is often more time consuming entering the information on each host.
