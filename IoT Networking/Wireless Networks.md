...
---
#### GPS
The **GPS** uses satellites to transmit signals that cover the globe. A **smartphone** can receive these signals and calculate the *phone’s location* to an accuracy of within 10 meters.
