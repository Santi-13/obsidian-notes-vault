...
---
### RIR IPv4 Exhaustion
**IPv6** is designed to be a successor to **IPv4**, following the growing trends of exhaustion of IPv4's 32-bit addresses. IPv6 has a larger 128-bit address space, providing 340 undecillion (i.e., 340 followed by 36 zeroes) possible addresses.
