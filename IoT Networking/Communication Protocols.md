...
| Message Size            | Differs depending on used channel. If a message is too long to be sent directly from one **host** to another, it may be broken down into smaller chunks.                                                                  |
