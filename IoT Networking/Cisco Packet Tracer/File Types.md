...
##### *Getting started with Cisco Network Packet Tracer*
---
...
###### The .pkt File Type
The .pkt file type is created when a simulated network is built in Packet Tracer and saved. The .pkt file can also have graphic background images embedded within it. 
###### The .pksz File Type
